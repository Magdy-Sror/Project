                        ...
                        <div className='container'>
                            <div className='row'>
                                ...
                                <div className='col-lg-6 pe-5 mt-5 mb-2'>
                                    <a className='text-white' href='Hosp'>المستشفيات الحكومية</a>
                                </div>


                                <div className='col-lg-6 pe-5 mt-5 mb-2'>
                                    <a className='text-white' href='SchoolS'>المدارس الحكومية </a>
                                </div>
                                ...
                                <div className='col-lg-6 pe-5 mb-2'>
                                    <a className='text-white' href='/'>وسائل المواصلات </a>
                                </div>
